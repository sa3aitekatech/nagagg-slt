    ...
    return (
        ...
        >
            <div className="champion-detail__content">
                ...
                <span>RTP : <span className="second-color">{item.role}</span></span>
                <br />
                <span>Provider : <span className="second-color">{item.difficulty}</span></span>
                <div className="story">
                    {item.description}
                </div>
                <span>NagaGG Spotlight</span>
                <div className="video">
                    <iframe
            ...
            <div className="champion-detail__close" onClick={onClose}>
                <img src={closeIcon} alt="nagagg situs slot gacor" />
            </div>          
        </div>
    )
}
